defmodule Pento.SurveyTest do
  ...
  describe "demographics" do
    ...
    test "create_demographic/1 with valid data creates a demographic" do
      valid_attrs = %{gender: "female", year_of_birth: 1999, user_id: user_fixture().id}
  ...
  describe "ratings" do
    ...
    test "update_rating/2 with valid data updates the rating" do
      rating = rating_fixture()
      update_attrs = %{stars: 4, user_id: user_fixture().id, product_id: product_fixture().id}
